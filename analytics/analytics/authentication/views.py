...
OAUTH_CLIENT_ID = 'r9bUXc6EogZ0q94H5wjtmPAbh6BRnLYcwIv4IKwL'
OAUTH_CLIENT_SECRET = 'zoWXw88Tgiu3oPUhNWZCfB7ZyY7Rdwn5T1NMKlQFOqlgrZ2knpt6atU4scYvsCIBeNovRRvvmYZGClTdo2Al2UOb0HkrBaBnoDY77hMNSUjQldIbAiWcDjq3qgRBQW9Q'
...
class AuthLoginView(APIView):
    def get(self, request):
        ...
        redirect_uri = 'http://localhost:3000/api/callback'  # URL to handle the callback after authentication
...
class AuthCallbackView(APIView):
    def get(self, request):
        ...
        redirect_uri = 'http://localhost:3000/api/callback'  # Redirect URI used during login
